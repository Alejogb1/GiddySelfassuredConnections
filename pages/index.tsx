...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4 sm:p-6">
      <div className="max-w-xl w-full bg-white rounded-lg shadow-lg p-6 sm:p-8">
        ...
        <div className="mt-2 p-3 sm:p-4 bg-gray-100 rounded-md border border-gray-200 max-h-100 overflow-y-auto">
          {summary ? (
